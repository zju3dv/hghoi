...
public class ContactModule : Module
{
    ...
    public void PrintRootRot(string prefix, Actor actor)
    {
        Debug.Log(prefix);
        Matrix4x4 root = actor.GetRoot().GetWorldMatrix(true);
        Debug.Log("contact root pos: " + root[0, 3] + ", " + root[1, 3] + ", " + root[2, 3]);
        Debug.Log("contact root rotx: " + root[0, 0] + ", " + root[1, 0] + ", " + root[2, 0]);
        Debug.Log("contact root roty: " + root[0, 1] + ", " + root[1, 1] + ", " + root[2, 1]);
        Debug.Log("contact root rotz: " + root[0, 2] + ", " + root[1, 2] + ", " + root[2, 2]);
    }
